...
class casesStack extends Stack {
  ...
  constructor(scope, id, props, envVariables) {
    ...
    const authScopeListCase = envVariables.authScopeListCase;
    const authScopeListTemplate = envVariables.authScopeListTemplate
    ...
    getCase.addMethod("POST"),
      ...
      const listCase = caseApiGateway.root.addResource("listCase");
      listCase.addMethod("POST"),
        {
          authorizationType: apigateway.AuthorizationType.COGNITO,
          authorizer: apiAuth,
          authorizationScopes: [authScopeListCase],
          requestTemplates: {
            "application/json": '{ "statusCode": "200" }',
          },
          integrationResponses: [{
        ...
        const listTemplate = caseApiGateway.root.addResource("listTemplate");
        listTemplate.addMethod("POST"),
          {
            authorizationType: apigateway.AuthorizationType.COGNITO,
            authorizer: apiAuth,
            authorizationScopes: [authScopeListTemplate],
            requestTemplates: {
              "application/json": '{ "statusCode": "200" }',
            },
            integrationResponses: [{
